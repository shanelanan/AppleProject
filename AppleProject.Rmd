...
A python3 backend was developed to fetch the raw data sources and push them into a local Sqlite database.  This provides a clean and normalized interface for future analyses.
