...
A python3 backend was developed to fetch all of the raw data sources and push them into a local Sqlite database.  This provides a clean and normalized interface for future analysis.

In a production environment:
  * Python calls would be scheduled via Unix crontab or Windows task scheduler
  * Sqlite would be replaced by a server-based platform, like Oracle, SQL Server, MySQL, etc.
