...
# m1_bwd <- step(m1_full, direction="backward", trace=FALSE), not good for high dimensionality problem
# m1_fwd <- step(m1_null, scope=list(lower=m1_null, upper=m1_full, trace=FALSE), direction="forward")  both has lower AIC
# m1_both <- step(m1_null, scope = list(upper=m1_full), direction="both", trace=FALSE) best choice

m1_base <- step(m1_null, scope = list(upper=m1_full), direction="both", trace=FALSE)
summary(m1_base)
```
